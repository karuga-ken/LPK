...
function Landing() {
  ...
  return (
    <>
        ...
        <div id='hero' className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-skobeloff bg-opacity-10 backdrop-filter backdrop-blur-sm py-4 px-6 sm:py-10 sm:px-2 flex justify-center">
