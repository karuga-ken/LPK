  ...
  return (
    <>
        <div>
            ...
            <div className='px-24 mx-20 '>
                <h1 className='text-3xl text-red-500' style={{letterSpacing:'1px'}}>
                    SPONSOR A CHILD
                </h1>
            <div className='flex gap-10 mb-10 mt-10'>
                    ...
                    <div className='flex gap-10 mb-10 mt-10'>
                        ...
                        <div className='w-1/2'>
                            <img className='rounded-md' src={hap}/>
                        </div>
